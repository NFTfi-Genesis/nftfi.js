  ...
  (0, _createClass2["default"])(Contract, [{
    ...
    value: function () {
      var _call = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(options) {
        var result, isViewFn, _classPrivateFieldGet2, _classPrivateFieldGet3, tx;
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                tx = _context.sent;
                result = (0, _classPrivateFieldGet5["default"])(this, _account).execTransaction(tx);
