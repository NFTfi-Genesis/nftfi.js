...
mainnetConfig.immutable.v1.abi = ['event Transfer(address indexed from, address indexed to, uint256 indexed tokenId)', 'function bundleOfImmutable(uint256 bundleId) view returns (uint256 immutableId)', 'function withdraw(uint256 immutableId, address to)'];
...
goerliConfig.immutable.v1.abi = ['event Transfer(address indexed from, address indexed to, uint256 indexed tokenId)', 'function bundleOfImmutable(uint256 bundleId) view returns (uint256 immutableId)', 'function withdraw(uint256 immutableId, address to)'];
