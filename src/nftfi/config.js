...
mainnetConfig.protocol.v3.coordinator.abi = [
  'function getWhetherNonceHasBeenUsedForUser(bytes32 _offerType, address _user, uint256 _nonce) view returns (bool)',
  'function getDefaultLoanContractForOfferType(bytes32 _offerType) view returns (address)',
  'function getLoanData(uint32 _loanId) view returns (tuple(address, uint64, uint8))',
  'function getLoanDataAndOfferType(uint32 _loanId) view returns (tuple(address, uint64, uint8), bytes32)',
...
mainnetConfig.protocol.v3.assetOfferLoan.v1.abi = [
...
sepoliaConfig.protocol.v3.coordinator.abi = [
  'function getWhetherNonceHasBeenUsedForUser(bytes32 _offerType, address _user, uint256 _nonce) view returns (bool)',
  'function getDefaultLoanContractForOfferType(bytes32 _offerType) view returns (address)',
  'function getLoanData(uint32 _loanId) view returns (tuple(address, uint64, uint8))',
  'function getLoanDataAndOfferType(uint32 _loanId) view returns (tuple(address, uint64, uint8), bytes32)',
...
sepoliaConfig.protocol.v3.assetOfferLoan.v1.abi = [
  'function acceptOffer(tuple(uint256 loanPrincipalAmount, uint256 maximumRepaymentAmount, uint256 nftCollateralId, address nftCollateralContract, uint32 loanDuration, address loanERC20Denomination, bool isProRata, uint256 originationFee) _offer, tuple(uint256 nonce, uint256 expiry, address signer, bytes signature) _signature)',
  'function payBackLoan(uint32 _loanId)',
  'function liquidateOverdueLoan(uint32 _loanId) nonpayable returns()',
  'function mintObligationReceipt(uint32 _loanId)',
...
class Config {
  constructor(options = {}) {
    ...
    const mergedConfig = merge(baseConfig, customConfig, { version });
